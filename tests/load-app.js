...
const TEST_BRIDGE_SNIPPET = `
  ...
  globalThis.__TEST_BRIDGE__ = {
    ...
    getSite: ()=>site,
    setSite: (s)=>{ site = s; },
    defaultState, stripLegacyPipeSizeField, migrateLegacyPointLabels, migrateLegacyNumbering, migrateLoadedChecks,
    ...
    isTerminalMasuType, isPhysicalManhole, physicalIndexBefore, effectiveMasuType,
    handleDirectionTap, renumberPoints,
